...
jQuery.extend(jQuery.easing, {
    ...
    easeInElastic: function(e, t, i, a, o) {
        ...
        p < Math.abs(a)) {
            ...
            var s = n / (2 * Math.PI) * Math.asin(a / p);
        return -(p * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * o - s) * (2 * Math.PI) / n)) + i
    },
    easeOutElastic: function(e, t, i, a, o) {
        ...
        p < Math.abs(a)) {
            ...
            var s = n / (2 * Math.PI) * Math.asin(a / p);
        return p * Math.pow(2, -10 * t) * Math.sin((t * o - s) * (2 * Math.PI) / n) + a + i
    },
    easeInOutElastic: function(e, t, i, a, o) {
        ...
        p < Math.abs(a)) {
            ...
            var s = n / (2 * Math.PI) * Math.asin(a / p);
        return 1 > t ? -.5 * (p * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * o - s) * (2 * Math.PI) / n)) + i : p * Math.pow(2, -10 * (t -= 1)) * Math.sin((t * o - s) * (2 * Math.PI) / n) * .5 + a + i
    },
    easeInBack: function(e, t, i, a, o, s) {
        return void 0 == s && (s = 1.70158),
        a * (t /= o) * t * ((s + 1) * t - s) + i
    },
    easeOutBack: function(e, t, i, a, o, s) {
        return void 0 == s && (s = 1.70158),
        a * ((t = t / o - 1) * t * ((s + 1) * t + s) + 1) + i
    },
    easeInOutBack: function(e, t, i, a, o, s) {
        return void 0 == s && (s = 1.70158),
        (t /= o / 2) < 1 ? a / 2 * (t * t * (((s *= 1.525) + 1) * t - s)) + i : a / 2 * ((t -= 2) * t * (((s *= 1.525) + 1) * t + s) + 2) + i
    },
    easeInBounce: function(e, t, i, a, o) {
        return a - jQuery.easing.easeOutBounce(e, o - t, 0, a, o) + i
    },
    easeOutBounce: function(e, t, i, a, o) {
        return (t /= o) < 1 / 2.75 ? a * (7.5625 * t * t) + i : 2 / 2.75 > t ? a * (7.5625 * (t -= 1.5 / 2.75) * t + .75) + i : 2.5 / 2.75 > t ? a * (7.5625 * (t -= 2.25 / 2.75) * t + .9375) + i : a * (7.5625 * (t -= 2.625 / 2.75) * t + .984375) + i
    },
...
function(e) {
    ...
    e.fn.quicksand = function(t, i) {
        ...
        e.extend(a, i),
        (e.browser.msie || "undefined" == typeof e.fn.scale) && (a.useScaling = !1);
        var o;
        ...
        return this.each(function(i) {
            var s, n, p = [], r = e(t).clone(), l = e(this), h = e(this).css("height"), c = !1, u = e(l).offset(), g = [], _ = e(this).find(a.selector);
            if (e.browser.msie && e.browser.version.substr(0, 1) < 7)
                return void l.html("").append(r);
            var m = 0
              , f = function() {
                m || (m = 1,
                $toDelete = l.find("> *"),
              ...
              , v = l.offsetParent()
              , y = v.offset();
            "relative" == v.css("position") ? "body" == v.get(0).nodeName.toLowerCase() || (y.top += parseFloat(v.css("border-top-width")) || 0,
            y.left += parseFloat(v.css("border-left-width")) || 0) : (y.top -= parseFloat(v.css("border-top-width")) || 0,
            y.left -= parseFloat(v.css("border-left-width")) || 0,
            y.top -= parseFloat(v.css("margin-top")) || 0,
            y.left -= parseFloat(v.css("margin-left")) || 0),
            isNaN(y.left) && (y.left = 0),
            isNaN(y.top) && (y.top = 0),
            y.left -= a.dx,
            y.top -= a.dy,
            l.css("height", e(this).height()),
            _.each(function(t) {
                g[t] = e(this).offset()
            }),
            e(this).stop();
            ...
            _.each(function(t) {
                e(this).stop();
                var i = e(this).get(0);
                "absolute" == i.style.position ? (w = -a.dx,
                b = -a.dy) : (w = a.dx,
                b = a.dy),
                i.style.position = "absolute",
                i.style.margin = "0",
                i.style.top = g[t].top - parseFloat(i.style.marginTop) - y.top + b + "px",
                i.style.left = g[t].left - parseFloat(i.style.marginLeft) - y.left + w + "px"
            });
            var P = e(l).clone()
              , $ = P.get(0);
            for ($.innerHTML = "",
            ...
            $.style.top = u.top - y.top + "px",
            $.style.left = u.left - y.left + "px",
            "dynamic" === a.adjustHeight ? l.animate({
                height: P.height()
            }, a.duration, a.easing) : "auto" === a.adjustHeight && (n = P.height(),
            parseFloat(h) < parseFloat(n) ? l.css("height", n) : c = !0),
            _.each(function(t) {
                var i = [];
                "function" == typeof a.attribute ? (s = a.attribute(e(this)),
                r.each(function() {
                    return a.attribute(this) == s ? (i = e(this),
                    !1) : void 0
                })) : i = r.filter("[" + a.attribute + "=" + e(this).attr(a.attribute) + "]"),
                i.length ? a.useScaling ? p.push({
                    element: e(this),
                    animation: {
                        top: i.offset().top - y.top,
                        left: i.offset().left - y.left,
                        opacity: 1,
                        scale: "1.0"
                    }
                }) : p.push({
            ...
            r.each(function(t) {
                ...
                r.each(function() {
                    return a.attribute(this) == s ? (o = e(this),
                    !1) : void 0
                })) : (i = _.filter("[" + a.attribute + "=" + e(this).attr(a.attribute) + "]"),
                o = r.filter("[" + a.attribute + "=" + e(this).attr(a.attribute) + "]"));
                var n;
                if (0 === i.length) {
                    n = a.useScaling ? {
                        opacity: "1.0",
                    ...
                    h.style.margin = "0",
                    h.style.top = o.offset().top - y.top + "px",
                    h.style.left = o.offset().left - y.left + "px",
                    d.css("opacity", 0),
            ...
            a.enhancement(l),
            i = 0; i < p.length; i++)
                p[i].element.animate(p[i].animation, a.duration, a.easing, f)
        })
    }
    ,
    e.prettyPhoto = {
    ...
    e.fn.prettyPhoto = function(i) {
        function a() {
            ...
            projectedTop = scroll_pos.scrollTop + ($ / 2 - g.containerHeight / 2),
            ...
            $pp_pic_holder.animate({
                top: projectedTop,
                left: k / 2 - g.containerWidth / 2,
                width: g.containerWidth
            }, settings.animation_speed, function() {
                $pp_pic_holder.find(".pp_hoverContainer,#fullResImage").height(g.height).width(g.width),
                ...
                !settings.autoplay_slideshow || w || _ || e.prettyPhoto.startSlideshow(),
        ...
        function n(e, t) {
            ...
            imageWidth = e,
            imageHeight = t,
            (y > k || v > $) && doresize && settings.allow_resize && !P) {
                for (resized = !0,
                fitting = !1; !fitting; )
                    y > k ? (imageWidth = k - 200,
                    imageHeight = t / e * imageWidth) : v > $ ? (imageHeight = $ - 200,
        ...
        function p(t, i) {
            ...
            e.browser.msie && 7 == e.browser.version && (detailsHeight += 8),
            $pp_details.remove(),
            ...
            m = i + detailsHeight,
            f = t,
            v = m + titleHeight + $pp_pic_holder.find(".pp_top").height() + $pp_pic_holder.find(".pp_bottom").height(),
            y = t
        }
        function r(e) {
            return e.match(/youtube\.com\/watch/i) ? "youtube" : e.match(/vimeo\.com/i) ? "vimeo" : e.match(/\b.mov\b/i) ? "quicktime" : e.match(/\b.swf\b/i) ? "flash" : e.match(/\biframe=true\b/i) ? "iframe" : e.match(/\bajax=true\b/i) ? "ajax" : e.match(/\bcustom=true\b/i) ? "custom" : "#" == e.substr(0, 1) ? "inline" : "image"
        }
        function l() {
            if (doresize && "undefined" != typeof $pp_pic_holder) {
                ...
                projectedTop = $ / 2 + scroll_pos.scrollTop - contentHeight / 2,
                projectedTop < 0 && (projectedTop = 0),
                contentHeight > $)
                    return;
                $pp_pic_holder.css({
        ...
        function h() {
            $ = e(window).height(),
            k = e(window).width(),
            "undefined" != typeof $pp_overlay && $pp_overlay.height(e(document).height()).width(k)
        }
        function c() {
            isSet && settings.overlay_gallery && "image" == r(pp_images[set_position]) && settings.ie6_fallback && (!e.browser.msie || 6 != parseInt(e.browser.version)) ? (itemWidth = 57,
        ...
        function u(t) {
            if (e("body").append(settings.markup),
        ...
        var g, _, m, f, v, y, w, b = this, P = !1, $ = e(window).height(), k = e(window).width();
        return doresize = !0,
        scroll_pos = d(),
        ...
        i.keyboard_shortcuts && e(document).unbind("keydown.prettyphoto").bind("keydown.prettyphoto", function(t) {
        ...
        e.prettyPhoto.initialize = function() {
            ...
            settings.ie6_fallback && e.browser.msie && 6 == parseInt(e.browser.version) && (settings.theme = "light_square"),
            theRel = e(this).attr("data-gal"),
            galleryRegExp = /\[(?:.*)\]/,
            isSet = galleryRegExp.exec(theRel) ? !0 : !1,
            pp_images = isSet ? jQuery.map(b, function(t, i) {
                return -1 != e(t).attr("data-gal").indexOf(theRel) ? e(t).attr("href") : void 0
            }) : e.makeArray(e(this).attr("href")),
            pp_titles = isSet ? jQuery.map(b, function(t, i) {
                return -1 != e(t).attr("data-gal").indexOf(theRel) ? e(t).find("img").attr("alt") ? e(t).find("img").attr("alt") : "" : void 0
            }) : e.makeArray(e(this).find("img").attr("alt")),
            pp_descriptions = isSet ? jQuery.map(b, function(t, i) {
                return -1 != e(t).attr("data-gal").indexOf(theRel) ? e(t).attr("title") ? e(t).attr("title") : "" : void 0
        ...
        e.prettyPhoto.open = function(o) {
            ...
            e.browser.msie && 6 == e.browser.version && (settings.theme = "light_square"),
            ...
            set_position = 0,
            u(o.target)),
            e.browser.msie && 6 == e.browser.version && e("select").css("visibility", "hidden"),
            settings.hideflash && e("object,embed").css("visibility", "hidden"),
            s(e(pp_images).size()),
            e(".pp_loaderIcon").show(),
            ...
            $pp_pic_holder.fadeIn(function() {
                ...
                case "image":
                    ...
                    imgPreloader.onload = function() {
                        g = n(imgPreloader.width, imgPreloader.height),
                        a()
                    }
                    ,
                    ...
                    break;
                case "youtube":
                    g = n(movie_width, movie_height),
                    movie = "../../../www.youtube.com/embed/" + t("v", pp_images[set_position]),
                    settings.autoplay && (movie += "../../../www.apple.com/qtactivex/qtplugin.cab/@autoplay=1"),
                ...
                case "vimeo":
                    ...
                    var i = /http:\/\/(www\.)?vimeo.com\/(\d+)/
                      , o = movie_id.match(i);
                    movie = "../../../player.vimeo.com/video/" + o[2] + "@title=0&byline=0&portrait=0",
                    settings.autoplay && (movie += "&autoplay=1;"),
                    vimeo_width = g.width + "/embed/?moog_width=" + g.width,
                    toInject = settings.iframe_markup.replace(/{width}/g, vimeo_width).replace(/{height}/g, g.height).replace(/{path}/g, movie);
                    break;
                case "quicktime":
                    g = n(movie_width, movie_height),
                    g.height += 15,
                    ...
                    toInject = settings.quicktime_markup.replace(/{width}/g, g.width).replace(/{height}/g, g.height).replace(/{wmode}/g, settings.wmode).replace(/{path}/g, pp_images[set_position]).replace(/{autoplay}/g, settings.autoplay);
                    break;
                case "flash":
                    g = n(movie_width, movie_height),
                    ...
                    toInject = settings.flash_markup.replace(/{width}/g, g.width).replace(/{height}/g, g.height).replace(/{wmode}/g, settings.wmode).replace(/{path}/g, filename + "?" + flash_vars);
                    break;
                case "iframe":
                    g = n(movie_width, movie_height),
                    frame_url = pp_images[set_position],
                    frame_url = frame_url.substr(0, frame_url.indexOf("iframe") - 1),
                    toInject = settings.iframe_markup.replace(/{width}/g, g.width).replace(/{height}/g, g.height).replace(/{path}/g, frame_url);
                    break;
                case "ajax":
                    doresize = !1,
                    g = n(movie_width, movie_height),
                ...
                case "inline":
                    ...
                    doresize = !1,
                    g = n(e(myClone).width(), e(myClone).height()),
                    doresize = !0,
                    e(myClone).remove(),
        ...
        e.prettyPhoto.changeGalleryPage = function(e) {
            ...
            slide_speed = settings.animation_speed) : "previous" == e ? (currentGalleryPage--,
            currentGalleryPage < 0 && (currentGalleryPage = totalPage),
            slide_speed = settings.animation_speed) : (currentGalleryPage = e,
            slide_speed = 0),
        ...
        e.prettyPhoto.startSlideshow = function() {
            "undefined" == typeof w ? ($pp_pic_holder.find(".pp_play").unbind("click").removeClass("pp_play").addClass("pp_pause").click(function() {
                return e.prettyPhoto.stopSlideshow(),
                !1
            }),
            w = setInterval(e.prettyPhoto.startSlideshow, settings.slideshow)) : e.prettyPhoto.changePage("next")
        }
        ,
        ...
        e.prettyPhoto.close = function() {
            ...
            $pp_overlay.fadeOut(settings.animation_speed, function() {
                e.browser.msie && 6 == e.browser.version && e("select").css("visibility", "visible"),
                settings.hideflash && e("object,embed").css("visibility", "visible"),
                e(this).remove(),
...
jQuery.fn.scrollerBird = function(e) {
...
!function() {
    ...
    function t() {
        if (!z && document.body) {
            ...
            e(),
            top != self && (C = !0),
            M.fixedBackground || T || (t.style.backgroundAttachment = "scroll",
    ...
    function n(e) {
        ...
        if (!a || e.defaultPrevented || e.ctrlKey)
            return !0;
        if (f(S, "embed") || f(n, "embed") && /\.pdf/i.test(n.src) || f(S, "object"))
            return !0;
        var r = -e.wheelDeltaX || e.deltaX || 0
          , i = -e.wheelDeltaY || e.deltaY || 0;
        return Y && (e.wheelDeltaX && h(e.wheelDeltaX, 120) && (r = -120 * (e.wheelDeltaX / Math.abs(e.wheelDeltaX))),
        e.wheelDeltaY && h(e.wheelDeltaY, 120) && (i = -120 * (e.wheelDeltaY / Math.abs(e.wheelDeltaY)))),
        r || i || (i = -e.wheelDelta || 0),
        1 === e.deltaMode && (r *= 40,
        i *= 40),
        !M.touchpadSupport && p(i) ? !0 : (Math.abs(r) > 1.2 && (r *= M.stepSize / 120),
...
//        e.preventDefault(),
    ...
    function a(e) {
        ...
        if (a.test(t.nodeName) || f(t, "input") && !r.test(t.type) || f(S, "video") || v(e) || t.isContentEditable || e.defaultPrevented || n)
            return !0;
        if ((f(t, "button") || f(t, "input") && r.test(t.type)) && e.keyCode === B.spacebar)
            return !0;
    ...
    function g(e) {
        return e >= 1 ? 1 : 0 >= e ? 0 : (1 == M.pulseNormalize && (M.pulseNormalize /= y(1)),
        y(e))
    }
    var S, k, D, x = {
        frameRate: 150,
...
//    window.localStorage && localStorage.SS_deltaBuffer && (X = localStorage.SS_deltaBuffer.split(","));
    ...
    "onwheel"in document.createElement("div") ? O = "wheel" : "onmousewheel"in document.createElement("div") && (O = "mousewheel"),
    O && (m(O, n),
    m("mousedown", r),
    m("load", t))
}();